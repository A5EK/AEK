...
|  This Is The Source Channel @U_24U .   |
|               - AEK -                 |
---------------------------------------------
...
local UserName = (dp.username_ or "U_24U")
...
local url,res = https.request('https://vcdrgj.ml/lion/SourcelionCh.php?id='..msg.sender_user_id_)
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/Song:"..data.sender_user_id_}},{{text="‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›",url="t.me/U_24U"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/mp3:"..data.sender_user_id_}},{{text="‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›",url="t.me/U_24U"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/remix:"..data.sender_user_id_}},{{text="‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›",url="t.me/U_24U"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/memz:"..data.sender_user_id_}},{{text="‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›",url="t.me/U_24U"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/gif:"..data.sender_user_id_}},{{text="‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›",url="t.me/U_24U"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/photo:"..data.sender_user_id_}},{{text="‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›",url="t.me/U_24U"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/anime:"..data.sender_user_id_}},{{text="‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›",url="t.me/U_24U"}}} 
...
EditMsg(Chat_Id2, Msg_Id2,'✫︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'U_24U')..')\n✫︙تم رفعه في قائمة المميزين')
end,nil)
...
local Text = '✫︙قم باستعمال الازرار لرفع العضو ↫ ⤈\n✫︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'U_24U')..')'
keyboard = {} 
if Sudo(data) then
...
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..Aek},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..Aek}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..Aek},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..Aek}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..Aek}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..Aek},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..Aek}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..Aek},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..Aek}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..Aek},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..Aek}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..Aek}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Aek},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Aek}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..Aek},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..Aek}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..Aek}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Aek},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Aek}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..Aek},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..Aek}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Aek},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Aek}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Aek}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
if text and text:match('^'..(DevAek:get(AEK..'Aek:NameBot') or "لايون")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAek:get(AEK..'Aek:NameBot') or "لايون")..' ','')
end
...
Dev_Aek(msg.chat_id_, msg.id_, 1, '✫︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'U_24U')..')'..' ❩\n✫︙تم رفعه ❨ '..DEV_AEEKAN..' ❩ بنجاح', 1, 'md')
...
if mrAek == "مميز" and VipMem(msg) then
Dev_Aek(msg.chat_id_, msg.id_, 1, '✫︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'U_24U')..')'..' ❩\n✫︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✫︙اهلا بك مجددا عزيزي المطور \n✫︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس لايون فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
Dev_Aek(msg.sender_user_id_, msg.id_, 1, '✫︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "U_24U")..')', 1, 'md') 
...
local text = text:gsub('username',(result.username_ or 'U_24U'))
...
local text = text:gsub('username',(msg.content_.members_[0].username_ or 'U_24U'))
Dev_Aek(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
...
if text and text == (DevAek:get(AEK..'Aek:NameBot') or 'لايون') then 
NameBot = (DevAek:get(AEK..'Aek:NameBot') or 'لايون')
...
⌁︙ LION TEAM
— >• — >• — >• 
⌁︙[Source Channel](https://t.me/U_24U)

⌁︙[ExpLaNaTiOns](https://t.me/ZBZBZ0)

⌁︙[ProGrAmmEr](https://t.me/A_llo1)
— >• — >• — >• 
⌁︙[𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇](https://t.me/So_rsbot)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=dp.first_name_,url=("t.me/"..dp.username_ or "t.me/U_24U")}}}
...
Text = "• *The developer and programmer of this source is* : [𝖫ꫀOn](https://t.me/A_llo1)."
keyboard = {} 
keyboard.inline_keyboard = {{{text='✫𝖫ꫀOn',url="t.me/A_llo1"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id='..msg.chat_id_..'&photo=https://t.me/A_llo1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=''..dp.first_name_..'',url="t.me/"..dp.username_ or U_24U}}}
local msg_id = msg.id_/2097152/0.5
...
local Text ='*✫︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/gif:"..msg.sender_user_id_}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*✫︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/memz:"..msg.sender_user_id_}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*✫︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/Song:"..msg.sender_user_id_}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*✫︙تم اختيار الاغنيه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*✫︙تم اختيار الريمكس لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/remix:"..msg.sender_user_id_}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*✫︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/photo:"..msg.sender_user_id_}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*✫︙تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="✫ مرة أخرى ᥀",callback_data="/anime:"..msg.sender_user_id_}},{{text = '‹  𝖲𝗈𝗎𝗋𝖼𝖾 ᒪ𝗂𝗈𝗇 ›',url="t.me/U_24U"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/U_24U' end
...
ConstructorAek = "["..Aek.first_name_.."](T.me/"..(Aek.username_ or "U_24U")..")"
else 
...
Dev_Aek(msg.chat_id_, msg.id_, 1, '✫︙جاري تحديث سورس لايون', 1, 'md') 
os.execute('rm -rf AEK.lua') 
os.execute('wget https://raw.githubusercontent.com/A5EK/AEK/master/AEK.lua') 
dofile('AEK.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/A5EK/AEKFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✫︙قائمة ملفات متجر سورس لايون\n✫︙الملفات المتوفره حاليا ↫ ⤈\n━───━ ✫ ━───━\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/A5EK/AEKFiles/master/AEKFiles/"..FileName)
if Res == 200 then
...
Dev_Aek(msg.chat_id_, msg.id_, 1, '✫︙Channel ↬ @U_24U', 1, 'html')    
end 
